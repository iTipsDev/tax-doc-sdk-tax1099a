# tax-doc-sdk-tax1099a

Software development kit to generate IRS Form 1099-A as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099A.sample.png" width="850"/>
